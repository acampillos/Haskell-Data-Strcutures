...
data SplayTree k v = Leaf
  | SplayTree k v Int (SplayTree k v) (SplayTree k v) deriving (Ord, Eq, Show)
...
--}
t :: SplayTree Int Int
t = SplayTree 0 0 12 Leaf Leaf

t2 :: SplayTree Int Int
t2 = SplayTree 100 0 0 (SplayTree 50 0 1 (SplayTree 40 0 2 (SplayTree 30 0 3 (SplayTree 20 0 4 Leaf Leaf) Leaf) Leaf) Leaf) (SplayTree 200 0 1 Leaf Leaf)